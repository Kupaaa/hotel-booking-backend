...
userRouter.delete("/:email", checkAuth, checkAdminAuth, deleteUser); // Route to delete a user by their email (requires admin auth)
userRouter.put("/:email", checkAuth, checkAdminAuth, updateUser); // Route to update a user by their email (requires admin auth)
